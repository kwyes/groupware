...
?>
	...
	<div id="popup_wrapper" style="display:<?=$popup_checked?>; width:100px;height:100px; z-index:99999; background-color:#CCCCCC;margin-left:19.7%; margin-top:0.7%; position:absolute; left:-50px; top:125px;">
		<div style="padding-top:5px; padding-left:5px;">
			<a target="_blank"><img width="200px" height="200px" src="welcome.png"></a>			
		</div>
