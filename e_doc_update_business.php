					...
					<tr>
						<td>
							<table width="100%">
								<tr>
									<td width="140"></td>
									<td align="center" class="doc_title">출장계획서</td>
									...
									<td style="border: 1px solid #c9c9c9;border-right:0px;">
										<table style = "border-collapse: separate;border: 1px solid #c9c9c9;margin: 19px 25px;">
												...
												<tr style = "height: 24px;">
													...
													<input name="bname1" type="text" style="width:100%; text-align:left;"  value=<?=$bname1?>></td>
									...
									<td colspan="2" style="border: 1px solid #c9c9c9;border-left:0px;">
										...
										<table style = "border-collapse: separate;border: 1px solid #c9c9c9;margin: 19px 0px;width:63%;">
												...
												<tr style="height: 24px;text-align:center;">
													...
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
													<input name="hotelpurpose" type="text" style="width:100%; text-align:left;"  value=<?=$Hotelpurpose?>></td>
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
												...
												<tr style="height: 24px;text-align:center;">
													...
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
													<input name="airpurpose" type="text" style="width:100%; text-align:left;"  value=<?=$Airpurpose?>></td>
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
												...
												<tr style="height: 24px;text-align:center;">
													...
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
													<input name="transpurpose" type="text" style="width:100%; text-align:left;"  value=<?=$Transpurpose?>></td>
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
												...
												<tr style="height: 24px;text-align:center;">
													...
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
													<input name="mealpurpose" type="text" style="width:100%; text-align:left;"  value=<?=$Mealpurpose?>></td>
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
												...
												<tr style="height: 24px;text-align:center;">
													...
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
													<input name="etcpurpose" type="text" style="width:100%; text-align:left;"  value=<?=$Etcpurpose?>></td>
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
												...
												<tr style="height: 24px;text-align:center;">
													...
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
													<input name="totalpurpose" type="text" style="width:100%; text-align:left;"  value=<?=$Totalpurpose?>></td>
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
										...
										<table id="business" style = "border-collapse: separate;border: 1px solid #c9c9c9;margin: 19px 25px;width:75.5%;">
											<tbody>
												<tr style = "height: 24px;">
													...
													<th colspan = "4" style = "width:280px;border-collapse: separate;border: 1px solid #c9c9c9;vertical-align: middle;"><input name="mainbusinesspurpose" type="text" style="width:100%;height:120%; text-align:left;" value = <?=$Mainpurpose?>></th>

												</tr>
												<tr style = "height: 24px;">
													<th style = "width:96px;border-collapse: separate;border: 1px solid #c9c9c9;vertical-align: middle;background-color:#F3E9E9;">기간 :</th>
													<th colspan = "4" style = "width:280px;border-collapse: separate;border: 1px solid #c9c9c9;vertical-align: middle;"><input name="businessduration" type="text" style="width:100%;height:120%;text-align:left;" value = <?=$Duration?>></th>
												</tr>
												<tr style="height: 24px;">
...
<?										
										while($row3 = mssql_fetch_array($query_result3)){
												...
												echo "<input type='text' name = 'businesspurpose[]' style='width:100%;text-align:left;' value = $Specificpurpose>";
												echo "</td>";
...
<?										
														while($row4 = mssql_fetch_array($query_result4)){
																...
																echo "<input type='text' name = 'businessdate[]' style='width:100%;text-align:left;'  value = $Businessdate>";
																echo "</td>";
																echo "<td style='text-align:center; width: 650px;'>";
																echo "<input type='text' name = 'companyvisit[]' style='width:100%;text-align:left;'  value=$Companyvisit >";
																echo "</td>";
