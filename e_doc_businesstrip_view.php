...
<?						if($sub == "view_done" || $sub == "view_complete" || $sub == "view_folder" || $sub == "view_submit" ||($menu == "view_all" && $row['ApprovalStatus'] == 1)) { ?>
							<td align="left"><!-- <input type="button" class="doc_submit_btn_style" onClick="printPage('<?=$ID?>','<?=$Type?>','<?=$Seq?>')" value="인쇄"> -->
<?
						if($sub == "view_complete" && $Type == '4') { 
							if($Totalpay == "") {	?>
							
							<input type="submit" class="doc_submit_btn_style" onClick="brief();" value="결과보고">
<?						} }?>
							</td>
<?						} ?>
						...
						<td align="center" valign="top">
							<table width="100%" style="border: 1px solid #c9c9c9; table-layout:fixed;">
								<tr class="doc_border">
									...
									<td colspan="2" class="doc_field_content"><b><?=create_DocID($ID, $Seq); ?></b></td>
...
<?									} ?>
								...
								<!-- Editor START -->
								<tr>
									<td align="center" class="doc_field_name" style="border: 1px solid #c9c9c9;border-right:0px;"><b>출장대상자<br /><br />경비내역</b></td>
									...
									<td style="border: 1px solid #c9c9c9;border-right:0px;">
										<table style = "border-collapse: separate;border: 1px solid #c9c9c9;margin: 19px 25px;">
												...
												<tr style="height: 24px;text-align:center;">
													...
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
													<input name="bpos2" type="text" style="width:100%; text-align:left;"value=<?="'".$bpos2."'"?>></td>
												</tr>
												<tr style="height: 24px;text-align:center;">
									...
									<td colspan="2" style="border: 1px solid #c9c9c9;border-left:0px;">
										...
										<table style = "border-collapse: separate;border: 1px solid #c9c9c9;margin: 19px 0px;width:63%;">
												...
												<tr style="height: 24px;text-align:center;">
													...
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
													<input name="hotelpay" type="text" style="width:100%; text-align:left;" readonly value=<?="'".$Hotelpay."'"?>></td>
												</tr>
												<tr style="height: 24px;text-align:center;">
													...
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
													<input name="airpay" type="text" style="width:100%; text-align:left;" readonly value=<?="'".$Airpay."'"?>></td>
												</tr>
												<tr style="height: 24px;text-align:center;">
													...
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
													<input name="transpay" type="text" style="width:100%; text-align:left;" readonly value=<?="'".$Transpay."'"?>></td>
												</tr>
												<tr style="height: 24px;text-align:center;">
													...
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
													<input name="mealpay" type="text" style="width:100%; text-align:left;" readonly value=<?="'".$Mealpay."'"?>></td>
												</tr>
												<tr style="height: 24px;text-align:center;">
													...
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
													<input name="etcpay" type="text" style="width:100%; text-align:left;" readonly value=<?="'".$Etcpay."'"?>></td>
												</tr>
												<tr style="height: 24px;text-align:center;">
													...
													<td style = "border-collapse: separate;border: 1px solid #c9c9c9;vertical-align:middle;">
													<input name="totalpay" type="text" style="width:100%; text-align:left;" readonly value=<?="'".$Totalpay."'"?>></td>
												</tr>
											</tbody>
										</table>
										...
										<table id="business" style = "border-collapse: separate;border: 1px solid #c9c9c9;margin: 19px 25px;width:75.5%;">
											<tbody>
												<tr style = "height: 24px;">
													...
													<th colspan = "4" style = "width:280px;border-collapse: separate;border: 1px solid #c9c9c9;vertical-align: middle;"><input name="mainbusinesspurpose" type="text" style="width:100%;height:120%; text-align:left;" readonly value = <?
													echo "'".$Mainpurpose."'"; ?>></th>
...
<?										
										while($row3 = mssql_fetch_array($query_result3)){
												...
												echo "<input type='text' style='width:100%;text-align:left;' readonly value = '$Specificpurpose'>";
												echo "</td>";
												echo "<td style='text-align:center; width: 78px;'>";
												echo "<input type='text' style='width:100%;text-align:left;' readonly value = '$Acheive'>";
												echo "</td>";
												echo "<td colspan='2' style='text-align:center; width: 335px;'>";
												echo "<input type='text' style='width:100%;text-align:left;' readonly value = '$Result'>";
												echo "</td>";
...
<?										
														while($row4 = mssql_fetch_array($query_result4)){
																...
																echo "<input type='text' style='width:100%;text-align:left;' readonly value = '$Businessdate'>";
																echo "</td>";
																echo "<td style='text-align:center; width: 650px;'>";
																echo "<input type='text' style='width:100%;text-align:left;' readonly value= '$Companyvisit' >";
																echo "</td>";
																echo "<td colspan = '2' style='text-align:center; width: 650px;'>";
																echo "<input type='text' style='width:100%;text-align:left;' readonly value= '$Resultforvisit' >";
																echo "</td>";
...
?>
								...
								<tr class="doc_border">
									...
									<td colspan = "2" class="doc_field_content" style="padding-top:5px; padding-bottom:5px;" colspan="<?=($row['ApprovalDate'] ? 2 : '' ); ?>">
...
if ($Type == 4) {
	...
	$query = "SELECT DocID, DocSeq, FileSeq, NewFilename FROM BusinessAttach ".
			 "WHERE DocID = $ID AND DocSeq = $Seq ".
			 "ORDER BY FileSeq ASC";
	$result33 = mssql_query($query);
	while($row33 = mssql_fetch_array($result33)) {
		$ImgVariable[$row33['FileSeq']] = $row33['NewFilename'];
	}
}
?>
...
<?
	...
	if($ImgVariable[1] && ($ext=="pdf" || $ext=="xlsx" || $ext=="xls" || $ext=="docx" || $ext=="doc")) { ?>
								<tr class="doc_border">
									...
									<td class="doc_field_content" colspan="3" style="border: 1px solid #c9c9c9;">
...
function brief(){
	...
	document.forms.form_proposal.action = "?page=e_doc&menu=offer&sub=result_view";
}
