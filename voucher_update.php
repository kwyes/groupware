...
<?
	...
	$today = date("Y-m-d");
	$query = "select a.ID, a.Type, a.Seq, a.Status, a.CompanyID, a.UserID, a.SubmitDate, a.Subject, a.RegDate, b.Contents ".
					$SEL_FIE.
					"from E_DOC_Header a ". $SEL_TAB.
					"where a.ID = ".$ID." and a.Seq = ".$Seq." and a.Type = ".$Type.
					$SEL_WHE;
	$row = mssql_query($query);
    $rst = mssql_fetch_array($row); 
?>
					...
					<tr>
						<td>
							<table width="100%">
								<tr>
									<td width="140"></td>
									<td align="center" class="doc_title"><?=get_docName($rst['Type'])?></td>
						...
						<td align="center" valign="top">
							<table width="100%" class="doc_border" style="table-layout:fixed;">
								<tr>
									...
									<td class="doc_field_content" style="border-right: 0;"><b><?=$rst['ID']?>-<?=$rst['Seq']?></b></td>
...
-									<td class="doc_field_content"><?=get_docName($rst['Type'])?></td>
									<td  width="95" align="center" class="doc_field_name"><b>실행 회사</b></td>
									<td  align="left" class="doc_field_content"><?=get_company_name($rst['CompanyID'])?></td>
								</tr>
								<tr>
									<td height="30" align="center" class="doc_field_name"><b>문서상태</b></td>
									<td class="doc_field_content"><?=Br_iconv(get_ApprovalStatus($rst['Status']))?></td>
									<td  width="95" align="center" class="doc_field_name"><b>Pay To</b></td>
									<td class="doc_field_content"><?if($Type == 3) { echo $rst['PayTo']; }?></input></td>
								</tr>
								<tr>
									<td height="30" align="center" class="doc_field_name"><b>부&nbsp;서&nbsp;명</b></td>
									<td class="doc_field_content"><?=get_Dept($memberDID)?></td>
									<td  width="95" align="center" class="doc_field_name"><b>Amount</b></td>
									<td class="doc_field_content"><?if($Type == 3) { echo $rst['Amount']; }?></td>
								</tr>
								<tr>
									...
									<td class="doc_field_content"><?if($Type == 3) { echo $rst['PaymentMethod']; }?></td>
								</tr>
								<tr>
									<td height="30" align="center" class="doc_field_name"><b>작성일자</b></td>
									<td class="doc_field_content"><?=$rst['RegDate']?></td>
									<td  width="95" align="center" class="doc_field_name"><b>Currency Type</b></td>
									<td class="doc_field_content"><?if($Type == 3) { echo $rst['CurrencyType']; }?></td>
								</tr>
								<tr>
									<td height="30" align="center" class="doc_field_name"><b>제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목</b></td>
									<td class="doc_field_content" colspan="4"><?=Br_iconv($rst['Subject'])?></td>
								</tr>
								<tr>
									<td height="30" align="center" class="doc_field_name"><b>내&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;용</b></td>
									<td colspan="4"  style="padding-left:11px;"><textarea name="ir1" id="ir1" rows="10" cols="100"><?=Br_iconv($rst['Contents'])?></textarea>
